...
# 51 "/gpfs/apps/NVIDIA/HMPP/HMPPWorkbench-3.2.3/include/openacci/openacci_c.h"
...
# 96 "/gpfs/apps/NVIDIA/HMPP/HMPPWorkbench-3.2.3/include/openacci/openacci_c.h"
...
# 108 "/gpfs/apps/NVIDIA/HMPP/HMPPWorkbench-3.2.3/include/openacci/openacci_c.h"
...
# 22 "/usr/include/_G_config.h" 3 4
...
# 4 "vecadd.c"
void  __hmpp_acc_region__oyl4mtyv_internal_1(__int32_t n, __int32_t *a, __int32_t *c, __int32_t *__hmpp_addr__i);
void  __hmpp_acc_region__yxqz3bjj_internal_1(__int32_t n, __int32_t *a, __int32_t *b, __int32_t *c, __int32_t *__hmpp_addr__i);
# 2740 "<preprocessor>"
void __hmpp_acc_region__2r7luxyf(int n, int *a, int *b, int *c, int __hmpp_addr__i[1], int __hmpp_addr__j[1])
{
...
void __hmpp_acc_region__up2b9qbv(int n, int *a, int *c, int __hmpp_addr__i[1], int __hmpp_addr__j[1])
{
  int  j = *__hmpp_addr__j;
  int  i = *__hmpp_addr__i;
  /* prologue placeholder */
...
# 2771 "<preprocessor>"
  ...
  *__hmpp_addr__j = j;
  /* epilogue placeholder */}
void __hmpp_acc_region__mzp4y33h(int n, int *b, int __hmpp_addr__i[1], int __hmpp_addr__j[1])
{
  int  j = *__hmpp_addr__j;
  int  i = *__hmpp_addr__i;
  /* prologue placeholder */
...
# 1 ""
      /* line_number    = */ 39,
# 1 ""
      /* function       = */ "__hmpp_acc_region__2r7luxyf" );
# 1 ""
}
# 1 ""
else
...
# 1 ""
  ...
  __hmpp_acc_region__2r7luxyf(n, a, b, c, &i, &j);
...
# 1 ""
      /* line_number    = */ 46,
# 1 ""
      /* function       = */ "__hmpp_acc_region__up2b9qbv");
# 1 ""
}
# 1 ""
else
...
# 1 ""
  ...
  __hmpp_acc_region__up2b9qbv(n, a, c, &i, &j);
...
# 1 ""
      /* line_number    = */ 53,
# 1 ""
      /* function       = */ "__hmpp_acc_region__mzp4y33h");
# 1 ""
}
# 1 ""
else
...
# 1 ""
  ...
  __hmpp_acc_region__mzp4y33h(n, b, &i, &j);
